  ...
  \resizebox{0.8\textwidth}{!}{
      \begin{minipage}[t]{0.4\textwidth}\vspace{0pt}
        \begin{subfigure}[t]{\linewidth}\centering
          \rsmgone[0.95] % подгони геометрию слева
          \caption{RSM for query $G_1$ (\ref{eqn:g_1})}\label{fig:rsm_g1}
        \end{subfigure}
      \end{minipage}\hspace{0pt}
      \begin{minipage}[t]{0.53\textwidth}\vspace{0pt}
          \vspace{1.8em}
        \begin{subfigure}[t]{\linewidth}\centering
          \rsmgtwo[0.80] % правая верхняя: геометрия меньше, шрифт тот же
          \caption{RSM for query $G_2$ (\ref{eqn:g_2})}\label{fig:rsm_g2}
        \end{subfigure}
        ...
        \begin{subfigure}[t]{\linewidth}\centering
          \rsmgeo[0.80]
          \caption{RSM for query \textit{Geo} (\ref{eqn:geo})}\label{fig:rsm_geo}
        \end{subfigure}
      \end{minipage}
  }
  \caption{RSMs for queries.}
