...
The results of context-free path query evaluations are presented in Fig.~\ref{fig:performance}~a for $G_1$, Fig.~\ref{fig:performance}~b for $G_2$, and Fig.~\ref{fig:performance}~c for \textit{Geo}. 
...
\begin{figure}
    ...
    \small{(c)}
    \end{minipage}%
    \caption{Multiple source CFPQ reachability results for queries: (a)~$G_1$, (b)~$G_2$, (c)~$Geo$ related to RDF analysis.}
