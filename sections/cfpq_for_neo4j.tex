...
In this section we provide details on the integration of the GLL-based CFPQ to Neo4j graph database. We choose the RSM-based version because our comparison (see section~\ref{sectioin:cfg_vs_rsm}) shows that it is faster than the BNF-based one.
