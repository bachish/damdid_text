...
\begin{figure}
    \centering
    \subfloat[$G_1$ query\label{fig:speedup-g1}]{%
        \includegraphics[width=\speedImageW\textwidth]{figures/g1_kotgll_result.eps}
    }%
    \subfloat[$G_2$ query\label{fig:speedup-g2}]{%
        \includegraphics[width=\speedImageW\textwidth]{figures/g2_kotgll_result.eps}
    }%
    \subfloat[$Geo$ query\label{fig:speedup-geo}]{%
        \includegraphics[width=\speedImageW\textwidth]{figures/geo_kotgll_result.eps}
    }%
